...
- A bounded candidate is not identified when evidence is uncalibrated, the profile hits the fixed-prior boundary, optimized profile coverage is incomplete, high-confidence integer assignments are non-primitive, or bootstrap/measurement-MC mode stability fails.
